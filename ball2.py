		...
		if check_collide(big_ball,ball) == True:
			...
			if radius33 < radius44:
				...
				if score == 50:
					...
					scoret.goto(0,250)
					scoret.clear()
					scoret.write("THE SCORE: " + str(score),align="center",font=("Arial", 20, "normal"))
					scoret.goto(0,0)
					scoret.write("congraduations,you won", align="center",font=("Arial", 100 ,"normal"))
					...
					scoret.goto(0,250)
					scoret.clear()
					scoret.write("the score is : " + str(score),align="center",font=("Arial", 20, "normal"))
...
while running == True:
	...
	if check_myball_collision() == False:
		running = False
		turtle.goto(0,0)
		turtle.write("unfortunatly you lost",align="center",font=("Arial", 50, "normal"))
		print("COLLIDING")
		#turtle.bye()
	getscreen().update()
	time.sleep(sleep)
